...
class Main
    ...
    def calculate_bill
        @userProducts.each do |product|
            @totolAmount += product.price*product.quantity + product.tax
    ...
    def generate_receipt
        ...
        print "\n\nProducts:"
        @userProducts.each do |product|
            print "\n"+product.quantity.to_s + (product.imported ? " imported ": " ").to_s + product.name.to_s + " : " + (product.price * product.quantity + product.tax).to_s
        end
